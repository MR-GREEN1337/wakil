...
export function Sparkles() {
  return (
    <div className="h-[40rem] w-full bg-transparent flex flex-col items-center justify-center overflow-x-hidden rounded-md">
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-9xl font-bold text-center text-white relative z-20">
        Wakil
      </h1>
      <div className="relative w-full max-w-screen-lg h-40">
        {/* Gradients */}
